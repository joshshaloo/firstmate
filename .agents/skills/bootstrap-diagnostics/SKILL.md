...
- `DECISION_HOLD: <answer reconciliation diagnostic>` - an answer file exists for a captain decision that is still open, or an open captain decision has the same key as an answer file.
