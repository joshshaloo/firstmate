...
- [docs/merge-watch.md](docs/merge-watch.md) - maintainer verification for GitLab merge watching on arbitrary instances and for Bitbucket Cloud pull request watching and merging.
