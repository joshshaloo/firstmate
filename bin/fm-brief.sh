...
When a decision you escalated is answered or a blocker clears and your domain resumes, append \`resolved [key=<slug>]: {how it was decided or unblocked}\` reusing the key you opened it with - or a bare \`resolved: {how it was decided or unblocked}\` when you opened it without one - so it is durably closed instead of resurfacing behind later unrelated events.
...
4. Report status by appending one line:
   ...
   firstmate then leaves your idle pane alone and rechecks it on the pause cadence instead of
