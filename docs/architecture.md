...
Before asking Treehouse for a new worktree, `fm-spawn.sh` starts short-lived cwd guards in every recorded worktree so Treehouse's process-based allocator cannot reset a slot this home already records as claimed.
