...
A Treehouse that hands out a claimed slot anyway is still caught by the record check, which refuses that slot, leaves it, and asks for another once the pane is back in the project checkout.
