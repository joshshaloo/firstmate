...
FM_STALE_ESCALATE_SECS=240         # idle seconds before a provably-working stale pane escalates, unless a current no-mistakes run-step has log or worktree file activity inside this same window; stale panes whose crew is not provably working surface immediately unless they declare the pause verb
