...
# Same-id restored-shell relaunch is covered deterministically in tests/fm-spawn-worktree-claim.test.sh.
# This presentation suite keeps ownership of projection creation, ordering, token fallback, and exact cleanup in the guarded lab.
