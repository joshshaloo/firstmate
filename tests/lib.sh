...
# reporters, a self-cleaning temp root, guaranteed reaping of backgrounded real
# processes plus the read-only process-table proof that grades it, a hermetic
# base PATH, fakebin/PATH-shim helpers, deterministic git identity and fixture
# builders, state/<id>.meta writers, and the common string/exit-code/file
